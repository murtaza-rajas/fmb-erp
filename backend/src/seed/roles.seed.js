...
const roleSeedData = [
  ...
  },
  {
    ...
    permissionKeys: [
      ...
      P.INVOICE_CREATE, P.INVOICE_READ, P.INVOICE_UPDATE, P.INVOICE_MATCH, P.INVOICE_HOLD, P.INVOICE_RELEASE, P.INVOICE_OVERRIDE_MATCH,
  ...
  },
  {
    ...
    permissionKeys: [
      ...
      P.EXPENSE_CREATE, P.EXPENSE_READ, P.EXPENSE_APPROVE, P.EXPENSE_REJECT,
      P.VENDOR_LEDGER_READ,
      P.MASTER_READ,
      P.REPORT_READ, P.REPORT_EXPORT,
    ],
